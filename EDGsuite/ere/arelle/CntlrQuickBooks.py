...
def processQbResponse(qbRequest, responseXml):
    ...
    for dataRowElt in responseQbDoc.iter("DataRow"):
        ...
        if qbReport == "Balance" and "Label" in cols:
        ...
        if qbReport == "Balance" and not hasRowDataAccount:
