...
<tr><td>checkbox</td><td> Balance.</td></tr>
...
To request xbrl-gl, select report type (generalLedger, journal, or Balance) and specify file name for xbrl-gl output instance.<br/>
