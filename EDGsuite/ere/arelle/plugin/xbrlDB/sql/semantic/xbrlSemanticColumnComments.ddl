...
COMMENT ON COLUMN entity.standard_industry_code 'Standard indus classification code provided with the filing when submitted to the regulatory authority';
