        ...
        if vb.isFactVar:
            ...
            if varHasNoVariableDependencies and varQname in cachedFilteredFacts:
                ...
                if groupFilteredFactsKey in cachedFilteredFacts:
                    ...
                    facts = FilterFacts(xpCtx, vb, facts, varSet.groupFilterRelationships, "group", varSet=varSet)
                ...
                facts = FilterFacts(xpCtx, vb, facts, var.filterRelationships, None, var=var) # also finds covered aspects (except aspect cover filter dims, not known until after this complete pass)
            ...
            if varSet.implicitFiltering == "true":
                if any((_vb.isFactVar and not _vb.isFallback) for _vb in xpCtx.varBindings.values()):
                    ...
                    if (considerFallback and varHasNoVariableDependencies and 
                        ...
                        _for_svc_311_1_like = True
                        if _for_svc_311_1_like:
...
def FilterFacts(xpCtx, vb, facts, filterRelationships, filterType, var=None, varSet=None):
